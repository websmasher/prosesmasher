...
DEFAULT_MODELS = ("gpt_5_4_mini",)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Snapshot and compare current failure counts for explainer fixtures."
    )
    ...
    parser.add_argument(
        "--fixtures-root",
        default="fixtures/explainers",
        help="Root directory containing explainer model fixture folders.",
    )
    parser.add_argument(
        "--preset",
        default="general-en",
    ...
    parser.add_argument(
        ...
        action="append",
        dest="models",
        help="Restrict to one or more model folders. Defaults to all explainer model folders.",
    )
...
def main() -> int:
    ...
    if not articles:
        print("No explainer fixtures found for the selected models.", file=sys.stderr)
        return 1
