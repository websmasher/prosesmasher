...
pub struct HeuristicsConfig {
    ...
    pub slogan_punchline: EnabledCheck,
...
impl Default for HeuristicsConfig {
    fn default() -> Self {
        Self {
            ...
            slogan_punchline: EnabledCheck { enabled: true },
            llm_vocabulary: AccumulativeCheck {
                enabled: true,
                max_per_document: 1,
            },
            softening_language: AccumulativeCheck {
                enabled: true,
                max_per_document: 1,
            },
            universalizing_claims: AccumulativeCheck {
                enabled: true,
                max_per_document: 1,
            },
